          ...
          <v-row justify="center">
            <v-col cols="12">
              ...
              <h3 class="font-weight-light mt-3">
                ...
                work of the service. Best regards, the Motivation Lover team.
              </h3>
              <h3 class="font-weight-light mt-3">
              ...
              <h3 class="font-weight-light mt-3">
                Email:
                <a href="mailto: motivationlover12@gmail.com">
                  motivationlover12@gmail.com
                </a>
              </h3>
              <h3 class="font-weight-light mt-3">
                We in telegram:
                <a href="https://t.me/motivationlover" target="_blank">
                  Motivation Lover Telegram
                </a>
              </h3>
            </v-col>
          </v-row>
