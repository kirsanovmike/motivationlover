        ...
        <v-col cols="10">
          <v-row align="center" justify="center">
            <v-col cols="12" md="6" xl="8">
              <h1 class="display-2 font-weight-bold mb-4">Motivation Lover</h1>
      ...
      features: [
        {
          ...
          title: "Amazing",
          text: "Our motivations will amaze everyone!",
        },
        {
          img: require("@/assets/img/lover.png"),
          title: "Favourites",
          text: "You can choose your favourite motivations to save them",
        },
        {
